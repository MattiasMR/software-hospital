...
class DisponibilidadBox(models.Model):
    idDisponibilidadBox = models.AutoField(
        primary_key=True,
...
class Especialidad(models.Model):
    idEspecialidad = models.AutoField(
        primary_key=True,
...
class EstadoConsulta(models.Model):
    idEstadoConsulta = models.AutoField(
        primary_key=True,
